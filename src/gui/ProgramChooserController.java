...
public class ProgramChooserController {
    ...
    private void displayProgram(ActionEvent actionEvent) {
        ...
        if (selectedStatement == null) {
            ...
            try {
                ...
                ProgramState programState = new ProgramState(new MyStack<>(), new MyDictionary<>(),  new MyList<>(), selectedStatement, new MyDictionary<>(), new MyHeap());
    ...
    private ObservableList<IStatement> getAllStatements() {
        ...
        IStatement ex1 = new CompoundStatement(new VariableDeclarationStatement("v", new IntType()),
                new CompoundStatement(new AssignmentStatement("v", new ValueExpression(new IntValue(3))),
