...
public class ProgramExecutorController {
    ...
    private void populateOutputListView() {
        ...
        List<Value> outputList = Objects.requireNonNull(programState).getOutput().getContent(); // getOut().getList()
        int index;
    ...
    private void populateSymbolTableView() {
        ProgramState programState = getCurrentProgramState();
        IDictionary<String, Value> symbolTable = Objects.requireNonNull(programState).getSymbolTable();
    ...
    private void populateExecutionStackListView() {
        ...
        if (programState != null) {
            for (IStatement statement : programState.getExecutionStack().getReverse()) {
